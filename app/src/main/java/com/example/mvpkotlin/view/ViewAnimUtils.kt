...
import com.example.mvpkotlin.MyApplication.Companion.context

/**
 * Anthor: Zhuangmingzhu
 * Date: 2019/3/21 下午3:00
 * Describe:动画工具类
 */
object ViewAnimUtils {
    ...
    fun animateRevealShow(context: Context, view: View,startRadius:Int,@ColorRes color:Int,listener:OnRevealAnimationListener){
    ...
    fun animateRevealHide(context: Context, view: View, finalRadius: Int, @ColorRes color: Int, listener: OnRevealAnimationListener){
        val cx = (view.left + view.right) / 2
        val cy = (view.top + view.bottom) / 2
