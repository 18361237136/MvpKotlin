...
class CircleImageView(context: Context,attrs:AttributeSet):AppCompatImageView(context,attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if(rawBitmap!=null&&mType!= TYPE_NONE){
            ...
            val dsWidth=(if(mType== TYPE_CIRCLE) viewMinSize else viewWidth).toFloat()
            val dsHeight=(if(mType== TYPE_CIRCLE) viewMinSize else viewHeight).toFloat()
            ...
            if(mShader!=null){
                mMatrix.setScale((dsWidth-doubleBorderWidth)/rawBitmap.width,(dsHeight-doubleBorderWidth)/rawBitmap.height)
            ...
            if(mType== TYPE_CIRCLE){
                ...
                mRectBorder.set(halfBorderWidth,halfBorderWidth,dsWidth-halfBorderWidth,dsHeight-halfBorderWidth)
                mRectBitmap.set(0.0f, 0.0f, dsWidth - doubleBorderWidth, dsHeight - doubleBorderWidth)
