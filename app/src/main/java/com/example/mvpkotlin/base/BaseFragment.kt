...
abstract class BaseFragment :Fragment(),EasyPermissions.PermissionCallbacks{
    ...
    /**
     * 这是用来判断对用户是否可见，单个fragment中不会调用该方法，一般用在ViewPager这样的切换里面
     * 下面的lazyLoadDataIfPrepared要在onActivityCreated里面也要执行一次，是因为默认显示第一页，第一页肯定要先
     * 加载数据而且该方法是在onCreatView之前，onCreatView需要初始化界面和修改isViewCreated的值所以需要再执行一次
     *
     */
