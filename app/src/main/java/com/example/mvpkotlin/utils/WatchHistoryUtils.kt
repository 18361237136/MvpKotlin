 ...
 * Date: 2019/3/19 下午5:42
 * Describe:kotlin委托属性+SharedPreference实例(记录视频观看记录的)
 */
class WatchHistoryUtils {
    companion object {

        //保存在手机里面的文件名
        private val FILE_NAME="mvp_kotlin_file"
        ...
        //创建一个解决SharedPreferencesCompat.apply方法 的一个兼容类
