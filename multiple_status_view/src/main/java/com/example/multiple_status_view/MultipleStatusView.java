 ...
 * Date: 2019/3/6 上午11:55
 * Describe:一个方便在多种状态切换的view
 */
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray typedArray=context.obtainStyledAttributes(attrs,R.styleable.MultipleStatusView,defStyleAttr,0);
